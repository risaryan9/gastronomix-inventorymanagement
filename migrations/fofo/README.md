...
**Status: 01–09 were applied to the live database on 2026-09-13**, in number order, each verified
...
verification block before moving on. 10 is not written yet.
...
| 10 | `10-create-fofo-accept-order-rpc.sql` | **not written yet** — the purchase manager's atomic accept | 07, 09 |
