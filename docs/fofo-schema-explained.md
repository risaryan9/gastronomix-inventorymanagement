...
**Status:** all of it — `migrations/fofo/` files 01–14 — was applied to the live
...
| The purchase manager's **accept** function (file 15) | Stock-out, trim and credit note in one step. Not written yet. |
