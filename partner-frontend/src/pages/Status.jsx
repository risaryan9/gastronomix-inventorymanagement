...
/*
 * /status — a deployment check anyone can open. It calls /api/health from the
 * browser, the same path every real screen takes, so it shows at a glance
 * whether the API is reachable and whether the server has its settings.
 */
          ...
          <ul className="space-y-2">
            ...
            <Row tone={health.body.configured ? 'good' : 'warn'}>
              {health.body.configured
                ...
                : 'Server settings incomplete — add them in Vercel → Settings → Environment Variables'}
            </Row>
          </ul>
        )}
      </section>
