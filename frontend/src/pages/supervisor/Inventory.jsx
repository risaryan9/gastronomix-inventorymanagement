      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-3 mb-4 lg:mb-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex gap-2 w-full lg:w-auto">
            ...
            <button className="flex-1 lg:flex-none bg-transparent text-accent font-semibold px-4 py-3.5 lg:px-5 lg:py-2.5 rounded-lg border-2 border-accent hover:bg-accent/10 transition-all text-sm lg:text-base">
              Export
            </button>
          </div>
        </div>
