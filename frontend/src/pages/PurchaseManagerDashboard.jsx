      ...
      <header className="bg-card border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-foreground">Purchase Manager Dashboard</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-card border border-border rounded-xl p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-semibold text-foreground capitalize">{session.role.replace('_', ' ')}</p>
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-card border border-border rounded-xl p-6">
            <h3 className="text-lg font-bold text-foreground mb-2">Purchase Orders</h3>
            <p className="text-sm text-muted-foreground mb-4">Create and manage purchase orders</p>
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            <h3 className="text-lg font-bold text-foreground mb-2">Suppliers</h3>
            <p className="text-sm text-muted-foreground mb-4">Manage supplier information</p>
            <button className="bg-accent text-background font-semibold px-4 py-2 rounded-lg hover:brightness-110 transition-all">
              View Suppliers
            </button>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">View inventory levels</p>
            <button className="bg-accent text-background font-semibold px-4 py-2 rounded-lg hover:brightness-110 transition-all">
              View Inventory
            </button>
          </div>
