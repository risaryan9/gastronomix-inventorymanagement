      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">View and track inventory</p>
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            <h3 className="text-lg font-bold text-foreground mb-2">Stock Updates</h3>
            <p className="text-sm text-muted-foreground mb-4">Update stock levels</p>
            <button className="bg-accent text-background font-semibold px-4 py-2 rounded-lg hover:brightness-110 transition-all">
              Update Stock
            </button>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">View inventory reports</p>
            <button className="bg-accent text-background font-semibold px-4 py-2 rounded-lg hover:brightness-110 transition-all">
              View Reports
            </button>
          </div>
